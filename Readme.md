...
```javascript
  // umd 格式
  "main": "dist/poster-components.umd.js",
  // es modules 格式
  "module": "dist/poster-components.esm.js",
```
...
```bash
// 安装
npm install poster-components --save
```

```javascript
import Poster from 'poster-components'
// 加载样式
import 'poster-components/dist/poster-components.css'

const app = createApp(App)
// 全局引入 目前包括 FinalPage, PText, PImage , Pshape三个组件
app.use(Poster)
